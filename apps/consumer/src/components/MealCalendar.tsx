            ...
            <div className="flex overflow-x-auto px-6 gap-3 no-scrollbar mb-10">
                {DAYS.map((day) => (
                    <button
                        ...
                        className={`px-6 py-3 rounded-2xl font-black text-xs uppercase tracking-tight transition-all shrink-0 ${selectedDay === day
            ...
            <div className="px-6 space-y-4">
                ...
                {PROTEINS.map((protein) => (
                    <div
                        ...
                        className={`p-6 rounded-[2.5rem] border-2 transition-all cursor-pointer flex justify-between items-center ${selections[selectedDay] === protein.id
